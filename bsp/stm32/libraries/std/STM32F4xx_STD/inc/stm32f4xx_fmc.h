...
#define IS_FMC_NORSRAM_BANK(BANK) (((BANK) == FMC_Bank1_NORSRAM1) || ((BANK) == FMC_Bank1_NORSRAM2) || ((BANK) == FMC_Bank1_NORSRAM3) || ((BANK) == FMC_Bank1_NORSRAM4))
/**
  * @}
  */
...
#define IS_FMC_MEMORY(MEMORY) (((MEMORY) == FMC_MemoryType_SRAM) || ((MEMORY) == FMC_MemoryType_PSRAM) || ((MEMORY) == FMC_MemoryType_NOR))
/**
  * @}
  */
...
#define IS_FMC_NORSRAM_MEMORY_WIDTH(WIDTH) (((WIDTH) == FMC_NORSRAM_MemoryDataWidth_8b) || ((WIDTH) == FMC_NORSRAM_MemoryDataWidth_16b) || ((WIDTH) == FMC_NORSRAM_MemoryDataWidth_32b))
/**
  * @}
  */
...
#define IS_FMC_BURSTMODE(STATE) (((STATE) == FMC_BurstAccessMode_Disable) || ((STATE) == FMC_BurstAccessMode_Enable))
/**
  * @}
  */
...
#define IS_FMC_ASYNWAIT(STATE) (((STATE) == FMC_AsynchronousWait_Disable) || ((STATE) == FMC_AsynchronousWait_Enable))
/**
  * @}
  */
...
#define IS_FMC_WAIT_POLARITY(POLARITY) (((POLARITY) == FMC_WaitSignalPolarity_Low) || ((POLARITY) == FMC_WaitSignalPolarity_High))
/**
  * @}
  */
...
#define IS_FMC_WAIT_SIGNAL_ACTIVE(ACTIVE) (((ACTIVE) == FMC_WaitSignalActive_BeforeWaitState) || ((ACTIVE) == FMC_WaitSignalActive_DuringWaitState))
/**
  * @}
  */
...
#define IS_FMC_WRITE_OPERATION(OPERATION) (((OPERATION) == FMC_WriteOperation_Disable) || ((OPERATION) == FMC_WriteOperation_Enable))
/**
  * @}
  */
...
#define IS_FMC_WAITE_SIGNAL(SIGNAL) (((SIGNAL) == FMC_WaitSignal_Disable) || ((SIGNAL) == FMC_WaitSignal_Enable))
/**
  * @}
  */
...
#define IS_FMC_ACCESS_MODE(MODE) (((MODE) == FMC_AccessMode_A) || ((MODE) == FMC_AccessMode_B) || ((MODE) == FMC_AccessMode_C) || ((MODE) == FMC_AccessMode_D))
/**
  * @}
  */
...
#define IS_FMC_WAIT_FEATURE(FEATURE) (((FEATURE) == FMC_Waitfeature_Disable) || ((FEATURE) == FMC_Waitfeature_Enable))
/**
  * @}
  */
...
#define IS_FMC_NAND_MEMORY_WIDTH(WIDTH) (((WIDTH) == FMC_NAND_MemoryDataWidth_8b) || ((WIDTH) == FMC_NAND_MemoryDataWidth_16b))
/**
  * @}
  */
...
#define IS_FMC_ECCPAGE_SIZE(SIZE) (((SIZE) == FMC_ECCPageSize_256Bytes) || ((SIZE) == FMC_ECCPageSize_512Bytes) || ((SIZE) == FMC_ECCPageSize_1024Bytes) || ((SIZE) == FMC_ECCPageSize_2048Bytes) || ((SIZE) == FMC_ECCPageSize_4096Bytes) || ((SIZE) == FMC_ECCPageSize_8192Bytes))
/**
  * @}
  */
...
#define IS_FMC_COLUMNBITS_NUMBER(COLUMN) (((COLUMN) == FMC_ColumnBits_Number_8b) || ((COLUMN) == FMC_ColumnBits_Number_9b) || ((COLUMN) == FMC_ColumnBits_Number_10b) || ((COLUMN) == FMC_ColumnBits_Number_11b))
...
#define IS_FMC_ROWBITS_NUMBER(ROW) (((ROW) == FMC_RowBits_Number_11b) || ((ROW) == FMC_RowBits_Number_12b) || ((ROW) == FMC_RowBits_Number_13b))
...
#define IS_FMC_SDMEMORY_WIDTH(WIDTH) (((WIDTH) == FMC_SDMemory_Width_8b) || ((WIDTH) == FMC_SDMemory_Width_16b) || ((WIDTH) == FMC_SDMemory_Width_32b))
...
#define IS_FMC_INTERNALBANK_NUMBER(NUMBER) (((NUMBER) == FMC_InternalBank_Number_2) || ((NUMBER) == FMC_InternalBank_Number_4))
...
#define IS_FMC_CAS_LATENCY(LATENCY) (((LATENCY) == FMC_CAS_Latency_1) || ((LATENCY) == FMC_CAS_Latency_2) || ((LATENCY) == FMC_CAS_Latency_3))
...
#define IS_FMC_WRITE_PROTECTION(WRITE) (((WRITE) == FMC_Write_Protection_Disable) || ((WRITE) == FMC_Write_Protection_Enable))
...
#define IS_FMC_SDCLOCK_PERIOD(PERIOD) (((PERIOD) == FMC_SDClock_Disable) || ((PERIOD) == FMC_SDClock_Period_2) || ((PERIOD) == FMC_SDClock_Period_3))
...
#define IS_FMC_READPIPE_DELAY(DELAY) (((DELAY) == FMC_ReadPipe_Delay_0) || ((DELAY) == FMC_ReadPipe_Delay_1) || ((DELAY) == FMC_ReadPipe_Delay_2))
...
#define IS_FMC_COMMAND_MODE(COMMAND) (((COMMAND) == FMC_Command_Mode_normal) || ((COMMAND) == FMC_Command_Mode_CLK_Enabled) || ((COMMAND) == FMC_Command_Mode_PALL) || ((COMMAND) == FMC_Command_Mode_AutoRefresh) || ((COMMAND) == FMC_Command_Mode_LoadMode) || ((COMMAND) == FMC_Command_Mode_Selfrefresh) || ((COMMAND) == FMC_Command_Mode_PowerDown))
...
#define IS_FMC_COMMAND_TARGET(TARGET) (((TARGET) == FMC_Command_Target_bank1) || ((TARGET) == FMC_Command_Target_bank2) || ((TARGET) == FMC_Command_Target_bank1_2))
...
#define IS_FMC_MODE_STATUS(STATUS) (((STATUS) == FMC_NormalMode_Status) || ((STATUS) == FMC_SelfRefreshMode_Status) || ((STATUS) == FMC_PowerDownMode_Status))
...
#define IS_FMC_GET_IT(IT) (((IT) == FMC_IT_RisingEdge) || ((IT) == FMC_IT_Level) || ((IT) == FMC_IT_FallingEdge) || ((IT) == FMC_IT_Refresh))

#define IS_FMC_IT_BANK(BANK) (((BANK) == FMC_Bank2_NAND) || ((BANK) == FMC_Bank3_NAND) || ((BANK) == FMC_Bank4_PCCARD) || ((BANK) == FMC_Bank1_SDRAM) || ((BANK) == FMC_Bank2_SDRAM))
/**
  * @}
  */
...
#define IS_FMC_GET_FLAG(FLAG) (((FLAG) == FMC_FLAG_RisingEdge) || ((FLAG) == FMC_FLAG_Level) || ((FLAG) == FMC_FLAG_FallingEdge) || ((FLAG) == FMC_FLAG_FEMPT) || ((FLAG) == FMC_FLAG_Refresh) || ((FLAG) == FMC_SDSR_BUSY))

#define IS_FMC_GETFLAG_BANK(BANK) (((BANK) == FMC_Bank2_NAND) || ((BANK) == FMC_Bank3_NAND) || ((BANK) == FMC_Bank4_PCCARD) || ((BANK) == FMC_Bank1_SDRAM) || ((BANK) == FMC_Bank2_SDRAM) || ((BANK) == (FMC_Bank1_SDRAM | FMC_Bank2_SDRAM)))
