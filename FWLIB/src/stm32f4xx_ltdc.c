...
void LTDC_LayerPosition(LTDC_Layer_TypeDef *LTDC_Layerx, uint16_t OffsetX, uint16_t OffsetY)
{
    ...
    else if ((tempreg == LTDC_Pixelformat_ARGB4444) || (tempreg == LTDC_Pixelformat_RGB565) || (tempreg == LTDC_Pixelformat_ARGB1555) || (tempreg == LTDC_Pixelformat_AL88))
    {
        temp = 2;
    }
    else
...
void LTDC_LayerPixelFormat(LTDC_Layer_TypeDef *LTDC_Layerx, uint32_t PixelFormat)
{
    ...
    else if ((PixelFormat == LTDC_Pixelformat_ARGB4444) || (PixelFormat == LTDC_Pixelformat_RGB565) || (PixelFormat == LTDC_Pixelformat_ARGB1555) || (PixelFormat == LTDC_Pixelformat_AL88))
    {
        temp = 2;
    }
    else
